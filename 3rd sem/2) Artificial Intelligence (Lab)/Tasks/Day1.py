...
def fibonacci():
    a,b=0,1
    input1=int(input("Enter the number for series: "))
    print(f"{a}\n{b}")
    while input1>0:
        input1-=1
        c=a+b
...
def primes():
    input1=int(input("Enter the smallest number for prime series: "))
    input2=int(input("Enter the smallest number for prime series: "))
...
def mini1():
    ...
    print("There will be 15 rounds in total.")
    print("Rules:")
